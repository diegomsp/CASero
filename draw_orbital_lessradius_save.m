function[a] = draw_orbital_lessradius_save(G,C,Nel,title_fig,varargin)
...
for  site = 1:length(G)
  ...
  filledCircle([G(site,1), G(site,2)],max(0.2*abs(Ccil(site,nstate)),0.000001),1000,color_circle);
end % site
